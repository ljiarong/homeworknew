    ...
    */
    ...
    public  List<String> delRegionByTemplateIdAndRegionId(Long tid,Long rid) throws RuntimeException{
        ...
        if (ret.isPresent()) {
            ...
            if (regionTemplatePoMapper.existsById(po.getId())){
                ...
                throw new BusinessException(ReturnNo.RESOURCE_ID_NOTEXIST, String.format(ReturnNo.RESOURCE_ID_NOTEXIST.getMessage(),"运费模板", po.getId()));
            }
        }
        return delKeys;
    }
