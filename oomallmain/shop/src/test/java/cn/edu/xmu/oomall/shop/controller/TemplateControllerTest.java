...
//    @Test
//    public void createWeightTemplate1() throws Exception{
//        Mockito.when(redisUtil.hasKey(Mockito.anyString())).thenReturn(false);
//        Mockito.when(redisUtil.set(Mockito.anyString(), Mockito.any(), Mockito.anyLong())).thenReturn(true);
//        String body = "{\"unit\":1,\"upperLimit\":4,\"firstWeight\":2, \"firstWeightFreight\":3,\"thresholds\":[{ \"below\": 1,\"price\":1}]}";
//        this.mockMvc.perform(MockMvcRequestBuilders.post(WEIGHT_TEMPLATE,1L,1L,666L)
//                        .header("authorization", adminToken)
//                        .content(body.getBytes("utf-8"))
//                        .contentType(MediaType.APPLICATION_JSON_VALUE))
//                .andExpect(MockMvcResultMatchers.status().isCreated())
...
//    @Test
//    public void createPieceTemplate1() throws Exception{
//        Mockito.when(redisUtil.hasKey(Mockito.anyString())).thenReturn(false);
//        Mockito.when(redisUtil.set(Mockito.anyString(), Mockito.any(), Mockito.anyLong())).thenReturn(true);
//        String body = "{\"unit\": 1,\"upperLimit\":4,\"firstItem\": 2,\"firstItemPrice\": 3,\"additionalItems\": 1,\"additionalItemsPrice\": 2}";
//        this.mockMvc.perform(MockMvcRequestBuilders.post(PIECE_TEMPLATE,1L,2L,999L)
//                        .header("authorization", adminToken)
//                        .content(body.getBytes("utf-8"))
//                        .contentType(MediaType.APPLICATION_JSON_VALUE))
//                .andExpect(MockMvcResultMatchers.status().isCreated())
