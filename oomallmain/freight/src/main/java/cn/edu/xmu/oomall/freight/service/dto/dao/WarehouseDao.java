...
import cn.edu.xmu.oomall.freight.service.dto.dao.bo.Warehouse;
...
//
    ...
    public PageInfo<Warehouse> retrieveWarehouseByRegionId(List<Long> ids, Integer page, Integer pageSize) {
        ...
        if (null != ids && ids.size() > 0) {
            ...
            warehousePoExample.createCriteria().andIdIn(ids).andInvalidEqualTo(Warehouse.VALID);
