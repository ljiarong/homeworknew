...
public class WarehouseLogisticsPoSqlProvider {
     ...
     * @mbggenerated
     */
    public String insertSelective(WarehouseLogisticsPo record) {
        BEGIN();
        INSERT_INTO("freight_warehouse_logistics");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        WarehouseLogisticsPo record = (WarehouseLogisticsPo) parameter.get("record");
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(WarehouseLogisticsPo record) {
        BEGIN();
        UPDATE("freight_warehouse_logistics");
     ...
     * @mbggenerated
     */
    protected void applyWhere(WarehouseLogisticsPoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
