...
public interface WarehouseRegionPoMapper {
    ...
    int insert(WarehouseRegionPo record);
    ...
    @SelectKey(statement="SELECT LAST_INSERT_ID()", keyProperty="id", before=false, resultType=Long.class)
    int insertSelective(WarehouseRegionPo record);
    ...
    int updateByExampleSelective(@Param("record") WarehouseRegionPo record, @Param("example") WarehouseRegionPoExample example);
    ...
    int updateByExample(@Param("record") WarehouseRegionPo record, @Param("example") WarehouseRegionPoExample example);
    ...
    int updateByPrimaryKeySelective(WarehouseRegionPo record);
    ...
    int updateByPrimaryKey(WarehouseRegionPo record);
}