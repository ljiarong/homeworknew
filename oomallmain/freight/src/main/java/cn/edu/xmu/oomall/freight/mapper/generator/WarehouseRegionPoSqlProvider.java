...
public class WarehouseRegionPoSqlProvider {
     ...
     * @mbggenerated
     */
    public String insertSelective(WarehouseRegionPo record) {
        BEGIN();
        INSERT_INTO("freight_warehouse_region");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        WarehouseRegionPo record = (WarehouseRegionPo) parameter.get("record");
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(WarehouseRegionPo record) {
        BEGIN();
        UPDATE("freight_warehouse_region");
     ...
     * @mbggenerated
     */
    protected void applyWhere(WarehouseRegionPoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
