...
public interface WeChatPayReceiverPoMapper {
     ...
     * This method corresponds to the database table oomall_wechatpay_receiver
     *
     * @mbg.generated
     */
    @Delete({
        "delete from oomall_wechatpay_receiver",
     ...
     */
    @Insert({
        "insert into oomall_wechatpay_receiver (`appid`, `type`, ",
    ...
    @Select({
        ...
        "from oomall_wechatpay_receiver",
        "where `id` = #{id,jdbcType=BIGINT}"
    })
    @Results({
        @Result(column="id", property="id", jdbcType=JdbcType.BIGINT, id=true),
     ...
     */
    @Update({
        "update oomall_wechatpay_receiver",
