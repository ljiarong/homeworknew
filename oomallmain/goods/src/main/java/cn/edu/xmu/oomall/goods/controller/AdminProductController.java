...
public class AdminProductController{
    ...
    @Autowired
    public AdminProductController(ProductService productService, OnsaleService onSaleService, ProductDraftService productDraftService) {
    ...
    public ReturnObject getOnsaleById(@PathVariable Long id) {
    ...
    public ReturnObject putGoods(@PathVariable Long shopId, @PathVariable Long id, @LoginUser UserDto user){
        this.productDraftService.putGoods(shopId, id, user);
        return new ReturnObject();
    }
     ...
     * @return
     */
    @PutMapping("/products/{id}/relations")
    public ReturnObject relateProductId(@PathVariable Long shopId, @PathVariable Long id, @RequestParam Long productId,
                                        @LoginUser UserDto user){
        this.productService.relateProductId(shopId, id, productId, user);
        return new ReturnObject();
    }
