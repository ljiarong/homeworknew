...
CREATE TABLE `freight_express` (
  ...
  `sender_region_id` bigint DEFAULT NULL,
  `sender_address` varchar(128) NOT NULL,
  `deliver_region_id` bigint NOT NULL,
  `deliver_address` varchar(128) NOT NULL,
  `sender_name` varchar(128) NOT NULL,
  `sender_mobile` varchar(64) NOT NULL,
  `deliver_name` varchar(128) NOT NULL,
  ...
  `deliver_mobile` varchar(64) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `freight_logistics` (
  ...
  `logistics_class` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `freight_logistics` VALUES (1,'顺丰快递','SF1001',1,'admin',NULL,NULL,'2022-12-02 18:59:35',NULL,'^SF[A-Za-z0-9-]{4,35}$',NULL,'sfDao'),(2,'中通快递','ZTO0002',1,'admin',NULL,NULL,'2022-12-02 19:07:09',NULL,'^ZTO[0-9]{12}$',NULL,'ztoDao'),(3,'极兔速递','JT11122',1,'admin',NULL,NULL,'2022-12-02 19:09:32',NULL,'^JT[0-9]{13}$',NULL,'jtDao');
...
INSERT INTO `freight_shop_logistics` VALUES (1,1,1,'secret1',1,'admin',NULL,NULL,'2022-12-02 11:32:34',NULL,0,3),(2,1,2,'secret2',1,'admin',NULL,NULL,'2022-12-02 11:32:34',NULL,0,113),(3,1,3,'secret3',1,'admin',NULL,NULL,'2022-12-02 11:32:34',NULL,1,2),(4,2,1,'secret1',1,'admin',NULL,NULL,'2022-12-02 11:33:09',NULL,0,3),(6,2,3,'secret3',1,'admin',NULL,NULL,'2022-12-02 11:33:09',NULL,0,5),(7,3,1,'secret1',1,'admin',NULL,NULL,'2022-12-02 11:33:16',NULL,0,3),(8,3,2,'secret2',1,'admin',NULL,NULL,'2022-12-02 11:33:16',NULL,0,4),(9,3,3,'secret3',1,'admin',NULL,NULL,'2022-12-02 11:33:16',NULL,0,5),(10,4,1,'secret1',1,'admin',NULL,NULL,'2022-12-02 11:33:22',NULL,0,3),(11,4,2,'secret2',1,'admin',NULL,NULL,'2022-12-02 11:33:22',NULL,0,4),(12,4,3,'secret3',1,'admin',NULL,NULL,'2022-12-02 11:33:22',NULL,0,5),(13,5,1,'secret1',1,'admin',NULL,NULL,'2022-12-02 11:33:28',NULL,0,3),(14,5,2,'secret2',1,'admin',NULL,NULL,'2022-12-02 11:33:28',NULL,0,4),(15,5,3,'secret3',1,'admin',NULL,NULL,'2022-12-02 11:33:28',NULL,0,123),(16,6,1,'secret1',1,'admin',NULL,NULL,'2022-12-02 11:33:34',NULL,1,3),(17,6,2,'secret2',1,'admin',NULL,NULL,'2022-12-02 11:33:34',NULL,0,4),(18,6,3,'secret3',1,'admin',NULL,NULL,'2022-12-02 11:33:34',NULL,0,3),(19,7,1,'secret1',1,'admin',NULL,NULL,'2022-12-02 11:33:40',NULL,0,35),(20,7,2,'secret2',1,'admin',NULL,NULL,'2022-12-02 11:33:40',NULL,0,44),(21,7,3,'secret3',1,'admin',NULL,NULL,'2022-12-02 11:33:40',NULL,0,5),(22,8,1,'secret1',1,'admin',NULL,NULL,'2022-12-02 11:33:46',NULL,0,23),(23,8,2,'secret2',1,'admin',NULL,NULL,'2022-12-02 11:33:46',NULL,0,4),(24,8,3,'secret3',1,'admin',NULL,NULL,'2022-12-02 11:33:46',NULL,1,10),(25,9,1,'secret1',1,'admin',NULL,NULL,'2022-12-02 11:33:52',NULL,0,3),(26,9,2,'secret2',1,'admin',NULL,NULL,'2022-12-02 11:33:52',NULL,0,4),(27,9,3,'secret3',1,'admin',NULL,NULL,'2022-12-02 11:33:52',NULL,0,5),(28,10,1,'secret1',1,'admin',NULL,NULL,'2022-12-02 11:33:57',NULL,0,5),(29,10,2,'secret2',1,'admin',NULL,NULL,'2022-12-02 11:33:57',NULL,0,4),(30,10,3,'secret3',1,'admin',NULL,NULL,'2022-12-02 11:33:57',NULL,0,22);
...
CREATE TABLE `freight_warehouse` (
  ...
  `gmt_modified` datetime DEFAULT NULL,
  `region_id` bigint NOT NULL,
  `sender_mobile` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
  `priority` int NOT NULL DEFAULT '1000',
  `invalid` tinyint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2022-12-25  9:35:28
