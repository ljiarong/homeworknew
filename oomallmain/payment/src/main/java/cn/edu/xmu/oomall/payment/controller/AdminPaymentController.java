...
import cn.edu.xmu.oomall.payment.service.dto.FullShopChannelDto;
import cn.edu.xmu.oomall.payment.service.RefundService;
import cn.edu.xmu.oomall.payment.service.dto.LedgerDto;
import cn.edu.xmu.oomall.payment.service.PaymentService;
import cn.edu.xmu.oomall.payment.service.dto.ShopChannelDto;
import cn.edu.xmu.oomall.payment.service.dto.SimpleShopChannelDto;
...
public class AdminPaymentController {
    ...
    @GetMapping("/channels/{id}/divrefundtrans")
    @Audit(departName = "shops")
    ...
    @GetMapping("/channels/{id}/divpaytrans")
    @Audit(departName = "shops")
    ...
    public ReturnObject retrievePayments(@PathVariable Long shopId,
                                         ...
                                         @RequestParam(required = false, defaultValue = "1") Integer page,
                                         @RequestParam(required = false, defaultValue = "10") Integer pageSize) {
        return new ReturnObject(paymentService.retrievePayments(shopId, id, outNo, adjustId, page, pageSize));
    }
}
