...
public class AdminPaymentController2Test {
    ...
    public void createShopChannelsTest() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post("/shops/1/channels/501/shopchannels")
                        .header("authorization", adminToken)
                        .contentType(MediaType.APPLICATION_JSON_VALUE)
                        .content(requestJson))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType("application/json;charset=UTF-8"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.errno", is(ReturnNo.PAY_CHANNEL_EXIST.getErrNo())))
                .andDo(MockMvcResultHandlers.print());
    }
